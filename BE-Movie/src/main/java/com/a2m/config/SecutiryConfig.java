...
public class SecutiryConfig {
	...
	public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
		...
		.antMatchers("/api/v1/account/checkPassword").authenticated()
		.antMatchers("/api/v1/account/updateUser").authenticated()
		.antMatchers("/api/v1/account/updatePassword").authenticated()
